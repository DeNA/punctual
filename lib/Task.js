...
var schema = {
    properties: {
        ...
        active: {
            description: "Is this task active?  Or disabled?  Do not run if this is false.",
            type: 'boolean',
            required: false
        },
        tagger: {
        ...
        data: {
            description: 'JSON serialized data for this specific cron task type',
...
Task.create = function(valuesObj, opts, cb) {
    ...
    taskObj.active = !(valuesObj.active === 'false' || valuesObj.active === false);
    ...
    if(typeof valuesObj.subType !== "undefined") taskObj.subType = valuesObj.subType;
    if(typeof valuesObj.tagger !== "undefined") taskObj.tagger = valuesObj.tagger;
    if(typeof valuesObj.data !== "undefined") taskObj.data = valuesObj.data;
